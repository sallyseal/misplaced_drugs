# Generated by Django 2.0.2 on 2018-03-01 12:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Comparison',
            fields=[
                ('PDB_Pair', models.CharField(max_length=12, primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='comparison',
            name='PDB1_ID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pdb1_id', to='repos.PDB'),
        ),
        migrations.AddField(
            model_name='comparison',
            name='PDB2_ID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pdb2_id', to='repos.PDB'),
        ),
        migrations.AddField(
            model_name='comparison',
            name='Target1_ID',
